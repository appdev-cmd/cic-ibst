...
Dưới đây là bảng phân tích chi tiết tính năng nghiệp vụ, đặc thù công nghệ, hiệu quả vận hành và **Dự toán phân bổ kinh phí phát triển** của **13 Phân hệ Nghiệp vụ** (Tổng kinh phí: **2.000.000.000 VNĐ**):

| STT | Tên Phân hệ | Mô tả Nghiệp vụ chính | Đặc thù phức tạp công nghệ (Yêu cầu phát triển) | Hiệu quả quản lý & Vận hành thực tế | Dự toán Phát triển (VNĐ) |
| :---: | :--- | :--- | :--- | :--- | :---: |
| **1** | **Dashboard Tổng quan Giám sát & Điều hành của Lãnh đạo Viện** | - Trung tâm tích hợp và trực quan hóa số liệu thời gian thực (Real-time BI) phục vụ công tác điều hành của Viện trưởng.<br>- Tích hợp 5 phân hệ giám sát chuyên sâu: (1) Chỉ số tổng quan toàn Viện; (2) Nghiên cứu khoa học & QLNN; (3) Kinh doanh & Thiết bị khoa học; (4) Tài chính & Đầu tư công; (5) Nhân sự & Hành chính.<br>- Tự động hóa đánh giá Chỉ số sức khỏe đơn vị (Unit Health Score) và dự báo dòng tiền về trong tương lai. | - Thuật toán tổng hợp dữ liệu (Data Aggregation Engine) đa chiều từ 16 đơn vị trực thuộc và 11 phòng thí nghiệm toàn quốc.<br>- Thiết lập biểu đồ nâng cao tích hợp (Composed Chart, Grouped Bar Chart) theo dõi cơ cấu và tăng trưởng so với năm trước. | - Cung cấp cho Ban Giám đốc góc nhìn toàn cục, tức thời về sức khỏe tài chính và tiến độ thực hiện nhiệm vụ chính trị của Viện.<br>- Hỗ trợ ra quyết định điều hành nhanh chóng, chính xác dựa trên số liệu thực tế thay vì báo cáo giấy. | **230.000.000** |
| **2** | **Quản lý Hợp đồng & Doanh thu** | - Đăng ký hợp đồng dịch vụ kỹ thuật, khảo sát, thiết kế chuyên ngành.<br>- Lập kế hoạch doanh thu & tiến độ xuất hóa đơn GTGT.<br>- Theo dõi sản lượng nghiệm thu thực tế theo giai đoạn.<br>- Thống kê nợ đọng khách hàng theo độ tuổi nợ (30-90-180 ngày).<br>- Tự động hạch toán tỷ lệ trích nộp nghĩa vụ Viện của 16 đơn vị trực thuộc theo Quyết định số 2815/QĐ-VKH. | - Áp dụng thuật toán phân bổ tài chính tự động theo mã phân loại hợp đồng (HĐKT, HĐTV, HĐGS, HĐTN).<br>- Cơ chế tự động quét số liệu nợ đọng và lập báo cáo cảnh báo tức thời. | - Lãnh đạo Viện kiểm soát chính xác dòng doanh thu và đôn đốc thu hồi công nợ.<br>- Chuẩn hóa công tác quản lý tài chính trích nộp nghĩa vụ, triệt tiêu sai sót thủ công. | **210.000.000** |
| **3** | **Quản lý Đề tài & Nhiệm vụ KHCN** | - Lưu trữ thuyết minh đề tài nghiên cứu khoa học cấp Nhà nước, cấp Bộ, cấp cơ sở.<br>- Quản lý tiến độ giải ngân kinh phí sự nghiệp khoa học phân bổ theo đợt cho các đơn vị.<br>- Theo dõi các mốc tiến độ thực hiện đề tài và hạn nghiệm thu.<br>- Số hóa tiến độ biên soạn Quy chuẩn Việt Nam (QCVN) và Tiêu chuẩn Việt Nam (TCVN). | - Xây dựng cơ chế giám sát song song: Tiến độ giải ngân kinh phí sự nghiệp và Tiến độ sản phẩm KHCN đầu ra. | - Đảm bảo tiến độ thực hiện các nhiệm vụ chính trị do Bộ Xây dựng giao.<br>- Quản lý nguồn vốn sự nghiệp KHCN minh bạch, đúng quy định tài chính. | **170.000.000** |
| **4** | **Kế toán & Quản lý Dòng tiền** | - Ghi nhận dòng tiền về thực tế từ các nguồn tạm ứng/thanh toán.<br>- Quản lý dòng tiền chi: Lương cán bộ, nghĩa vụ thuế (GTGT, TNDN, TNCN), trích nộp ngân sách và chi thường xuyên bộ máy.<br>- Tự động tính toán số dư khả dụng và cảnh báo dòng tiền âm tại các đơn vị trực thuộc. | - Tích hợp API đồng bộ hóa dữ liệu giao dịch ngân hàng hoặc liên thông hệ thống kế toán hiện hữu (MISA, Bravo). | - Bảo đảm an toàn thanh khoản toàn hệ thống Viện.<br>- Lãnh đạo ra quyết định phân bổ vốn đầu tư dựa trên số dư khả dụng thực tế. | **140.000.000** |
| **5** | **Quản lý Nhân sự & Tổ chức** | - Quản lý hồ sơ cán bộ công nhân viên (học hàm, học vị, chức danh khoa học).<br>- Quản lý Chứng chỉ hành nghề hoạt động xây dựng của cá nhân (thiết kế, khảo sát, giám sát...) theo QĐ 946/QĐ-BXD.<br>- Tự động cảnh báo chứng chỉ hành nghề sắp hết hạn trước 90 ngày. | - Mã hóa dữ liệu nhạy cảm cấp trường thông tin (Số định danh, mức lương).<br>- Thiết lập phân quyền truy cập đa cấp (RLS) bảo mật thông tin nhân sự. | - Phục vụ công tác chuẩn bị hồ sơ năng lực dự thầu chính xác.<br>- Hạn chế rủi ro pháp lý liên quan đến thời hạn chứng chỉ hành nghề của cán bộ. | **120.000.000** |
| **6** | **Quản lý Khách hàng & Đối tác** | - Hệ quản trị cơ sở dữ liệu đối tác chiến lược và khách hàng.<br>- Phân loại: Chủ đầu tư (đầu tư công/tư), Nhà thầu chính, Đối tác nghiên cứu KHCN & liên kết Đào tạo trong và ngoài nước.<br>- Thống kê lịch sử hợp tác và tổng số lượng hợp đồng đã ký kết. | - Thiết lập liên kết dữ liệu chéo (Cross-table reference) tự động đồng bộ số liệu từ phân hệ Hợp đồng sang hồ sơ khách hàng. | - Hỗ trợ công tác đánh giá khách hàng để đưa ra chính sách dịch vụ tối ưu.<br>- Quản lý hiệu quả quan hệ đối tác quốc tế. | **80.000.000** |
| **7** | **Kho Lưu trữ Hồ sơ Tài liệu Kỹ thuật** | - Lưu trữ số hóa thuyết minh đề tài, bản vẽ kỹ thuật CAD/BIM, báo cáo địa kỹ thuật, biên bản nghiệm thu.<br>- Quản lý trạng thái văn bản (Bản gốc scan, Bản chính thức đã ký số điện tử CA, Bản nháp). | - Phân quyền truy cập tài liệu chi tiết (Granular Access Control) đến từng cấp thư mục, cấp dự án và vai trò của người dùng. | - Bảo vệ tuyệt đối tài sản trí tuệ và bí mật kỹ thuật độc quyền của Viện.<br>- Dễ dàng tra cứu hồ sơ dự án cũ để tái sử dụng. | **140.000.000** |
| **8** | **Quản lý Thử nghiệm (LIMS)** | - Quy trình tiếp nhận mẫu, phân công phép thử phòng thí nghiệm chuyên ngành.<br>- Nhập kết quả thô và tự động tính toán cơ lý theo công thức chuẩn (TCVN, ASTM, Eurocode).<br>- Phê duyệt kết quả đa cấp và xuất **Phiếu kết quả thí nghiệm** chuẩn ISO/IEC 17025 kèm mã QR xác thực. | - Tích hợp bộ công cụ cấu hình biểu mẫu động Excel-like để người dùng tự thiết lập công thức tính toán phép thử mới.<br>- Tích hợp chữ ký số CA điện tử trực tiếp lên tệp PDF. | - Chuẩn hóa và tự động hóa quy trình nghiệp vụ của 11 phòng thí nghiệm LAS-XD toàn quốc.<br>- Rút ngắn 50% thời gian trả kết quả cho đối tác. | **290.000.000** |
| **9** | **Quản lý Đào tạo Sau Đại học (NCS)** | - Quản lý hồ sơ học tập và tiến độ nghiên cứu của Nghiên cứu sinh (Tiến sĩ).<br>- Theo dõi phân công giáo viên hướng dẫn khoa học.<br>- Quản lý các mốc bảo vệ luận án (Chuyên đề, Cấp cơ sở, Cấp Viện) và thủ tục thành lập Hội đồng chấm luận án. | - Xây dựng luồng phê duyệt hồ sơ khoa học đa bước tuân thủ quy chế tuyển sinh và đào tạo Tiến sĩ của Bộ GD&ĐT. | - Số hóa quy trình quản lý đào tạo Tiến sĩ uy tín của Viện.<br>- Đảm bảo NCS hoàn thành luận án đúng thời hạn quy định. | **100.000.000** |
| **10** | **Sở hữu Trí tuệ & Chuyển giao Công nghệ** | - Quản lý Bằng độc quyền sáng chế, Giải pháp hữu ích, Bản quyền phần mềm xây dựng của Viện.<br>- Cảnh báo thời hạn đóng phí duy trì bằng độc quyền sáng chế hàng năm.<br>- Quản lý hợp đồng chuyển giao công nghệ, giá trị thương mại và phân bổ hoa hồng khoa học cho tác giả. | - Kết nối trực tiếp dòng tiền thu từ chuyển giao công nghệ về phân hệ Kế toán để tự động tính toán phân bổ lợi ích cho tác giả sáng chế. | - Thương mại hóa hiệu quả kết quả nghiên cứu khoa học.<br>- Khuyến khích cán bộ nghiên cứu sáng tạo thông qua cơ chế phân chia hoa hồng tự động. | **110.000.000** |
| **11** | **Quản lý Văn bản & Số hóa DMS** | - Quản lý luồng văn bản đến: Nhận file scan, phân loại, trình Ban Giám đốc phê duyệt chỉ đạo số.<br>- Quản lý luồng văn bản đi: Dự thảo, duyệt nội dung, ký số phát hành điện tử.<br>- Tích hợp chữ ký số CA công cộng và chứng thư số Ban Cơ yếu.<br>- Kết nối gửi/nhận văn bản trực tiếp với Trục liên thông văn bản của Bộ Xây dựng. | - Công cụ thiết lập luồng phê duyệt động (Workflow engine).<br>- Tích hợp cổng API kết nối Trục liên thông văn bản Bộ Xây dựng (nhận/gửi gói tin XML mã hóa ký số CA). | - Triển khai văn phòng không giấy tờ (e-Office).<br>- Tiết kiệm 80% thời gian gửi nhận văn bản với Bộ Xây dựng và các cơ quan trực thuộc khác. | **170.000.000** |
| **12** | **Lịch công tác cơ quan & Phòng họp** | - Xây dựng Lịch công tác tuần của Viện và Lịch làm việc của Lãnh đạo Viện.<br>- Quy trình đăng ký và phê duyệt trực tuyến quyền sử dụng phòng họp, phòng hội thảo, xe công tác.<br>- Đồng bộ lịch biểu cơ quan đa nền tảng. | - Giải thuật giải quyết tranh chấp phòng họp thời gian thực (Room Booking conflict validation).<br>- Tích hợp cơ chế nhắc lịch họp thông minh qua thông báo đẩy. | - Nâng cao hiệu quả phối hợp công tác giữa Ban Giám đốc và các khoa/phòng.<br>- Tối ưu hóa hiệu suất khai thác tài sản chung (phòng họp, xe công vụ). | **130.000.000** |
| **13** | **Quản lý Thiết bị Lab & Đầu tư Công** | - Danh mục thiết bị thí nghiệm của 11 phòng LAS-XD.<br>- Cảnh báo nhắc lịch hiệu chuẩn/kiểm định máy móc trước 30 ngày để duy trì chứng chỉ phòng thí nghiệm.<br>- Giám sát tiến độ giải ngân vốn đầu tư công các dự án xây dựng của Viện (như tòa nhà 10 tầng). | - Công cụ nhắc nhở thông minh đa kênh (Email/Zalo/Notification) tích hợp lịch biểu hiệu chuẩn thiết bị tự động. | - Đảm bảo tính chính xác pháp lý của thiết bị thí nghiệm phòng Lab.<br>- Kiểm soát chặt chẽ dòng vốn đầu tư công, tránh chậm trễ tiến độ dự án. | **110.000.000** |
| | **TỔNG CỘNG DỰ TOÁN** | | | | **2.000.000.000** |
