 ...
 *
 * GIỚI HẠN MÔ HÌNH: hệ thống mới có 4 vai trò (quan-tri, lanh-dao, truong-don-vi,
 * chuyen-vien) nên chưa tách riêng được Phòng KHKT / Phòng Tổng hợp — bước thẩm tra
 * tạm quy về "Trưởng đơn vị trở lên". Khi bổ sung vai trò phòng chức năng thì siết lại
 * ở đây VÀ ở trigger fn_kiem_soat_ky_giao_viec (migration 0015).
 */
...
export const CAC_BUOC_KY: BuocKy[] = [
  ...
  { id: 'cho-khkt-tham-tra', nhan: '3. KHKT thẩm tra', moTa: 'Bộ phận chức năng' },
...
export function buocKeTiep(
  ...
  switch (hienTai) {
    ...
    case 'cho-khkt-tham-tra':
      return { den: 'cho-lanh-dao-duyet', nhanNut: 'KHKT thẩm tra đạt', vaiTroChoPhep: TU_TRUONG_DON_VI };
...
export function coTheTraLai(hienTai: TrangThaiGiaoViec, vaiTro: VaiTro): boolean {
  ...
  return dangXuLy && TU_TRUONG_DON_VI.includes(vaiTro);
}
